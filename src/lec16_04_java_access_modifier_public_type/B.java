...
import lec12_06_java_access_modifier_class_from_outside_package.M;
import lec12_06_java_access_modifier_class_from_outside_package.N;

public class B extends M { // first use C class to extend
	...
	public static void main(String[] args) {
		...
		A a1 = new A(); // here A is non-sub class
		...
		System.out.println("---------- The below is coming from class M of package 'lec12_06_java_access_modifier_class_from_outside_package' ----------\n");
		b.m1();
		
		System.out.println("\n---------- From different package, public type modifier content of different class can be accessed by non-subclass (Here Calculator02) ----------");
		System.out.println("---------- The below coded is coming from class N of package 'lec12_06_java_access_modifier_class_from_outside_package' ----------\n");
		N n1 = new N();
