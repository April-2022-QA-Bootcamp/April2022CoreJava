...
-- (no need) Converting primitive data types into objects is called boxing, and this is taken care of by the compiler.
-- String (not a Wrapper class), Character, Boolean are subclasses (child) of the class 'Object'. We don't need to import java.lang.Object
