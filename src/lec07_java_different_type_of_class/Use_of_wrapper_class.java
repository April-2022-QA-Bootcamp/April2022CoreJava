...
public class Use_of_wrapper_class {
	...
	public static void main(String[] args) {
		...
		System.out.println(name + 20); // 1020
		System.out.println(name + "20"); // 1020
		...
		// When the number is not pure, conversion from String to Integer is not
		...
		System.out.println(2.5 + 2.5 + Double.parseDouble(name3) + "  " + (1.25 + 1.25) + 0.5 + 1.0 + (2.0 + 3.0)); // 8.15
																													// 2.500.51.05.0
		...
		// Why? because float + double happening here, if we use f for rest of them, it
		// will show float value

		System.out.println("\n................. conversion from String to character .....................\n");
		// conversion from String to char (We will study it when we start String
		// Manipulation)
		...
		System.out.println(String.valueOf(isCitizen)); // false
