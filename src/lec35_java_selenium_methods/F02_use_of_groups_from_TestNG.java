...
public class F02_use_of_groups_from_TestNG {
	WebDriver driver;
	...
	// use of groups will be more clarified in automation framework when used
	...
	@Test (enabled = true, priority = 2, groups = {"functionalTest", "regressionTest"})
	...
	@Test (enabled = true, priority = 3, groups = {"sanityTest", "regressionTest"})
	...
	@Test (enabled = true, priority = 4, groups = {"smokeTest", "functionalTest", "regressionTest"})
