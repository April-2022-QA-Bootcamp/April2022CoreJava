...
When a match is found, and the job is done, it's time for a break. There is no need for more testing. Thus, a break can save a lot of execution time.
...
public class Info_switch_method {
