...
public class UseOfString02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("After trimming: " + s5.trim()); // Please see line 57 for solution of removing white space
		...
		System.out.println("\n------------------------------------------------------------------------\n");
		String dateOfToday = "06/09/2022"; // very much used
		...
		// You don't need to study below code now (learn later)
		// Will explain again soon
		// Just learn use of split()
		// The java string split() method splits this string against a given regular
