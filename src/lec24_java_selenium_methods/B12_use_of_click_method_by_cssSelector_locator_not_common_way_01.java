...
public class B12_use_of_click_method_by_cssSelector_locator_not_common_way_01 {
	WebDriver driver;
	@BeforeTest
	public void setUp() {
	...
	public void loginButtonTest() throws InterruptedException {
		driver.findElement(By.cssSelector("button[name='Submit Login']")).click();    // Learn from here , use of class attribute
		Thread.sleep(5000);
	}
