...
public class Employee extends MountSinai {
	...
	public Employee() {
		...
		// Constructor call must be the first statement in a constructor of child class --- [only one super() method is used]
	...
	public void employeeInfo(String empName, int empId, char sex, boolean fullTimeEmp) {
		...
		this.sex = sex;
		this.fullTimeEmp = fullTimeEmp;
		System.out.println("Emp Name: " + empName + ", Emp Id: " + empId + ", Emp Sex: " + sex + " and Is Full time employee? : " + fullTimeEmp);
	}
