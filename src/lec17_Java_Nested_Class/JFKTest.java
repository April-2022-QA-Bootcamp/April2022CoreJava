...
public class JFKTest {
	...
	public static void main(String[] args) {
		...
		jfk02.welcome();
		jfk02.t1.destination(); // also possible, but the above line can do the purpose, no need
		...
		jt01.arabianFlights();
		// JFK01.TerminalOne jt = new JFK01.TerminalOne();
		// non static inner class can't follow above line 27
